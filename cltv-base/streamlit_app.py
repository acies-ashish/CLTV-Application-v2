...
# IMPORTANT: Kedro typically reads from 01_raw. Point the fixed paths there.
...
def run_streamlit_app():
    ...
    with tab1:
        ...
        # Persist the "Use Sample Data" choice across reruns
            ...
            with st.spinner("Preparing data..."):
                try:
                    if st.session_state.get('use_sample_selected'):
                        ...
                        # Save uploads into 01_raw so Kedro can read them
